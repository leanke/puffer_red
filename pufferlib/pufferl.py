...
def autotune(args=None, env_name=None, vecenv=None, policy=None):
    ...
    module_name = (
        "pokered" if package == "pokered" else f"pufferlib.environments.{package}"
    )
...
def load_config(env_name):
    ...
    parser.add_argument("--wandb-group", type=str, default="pokered")
    parser.add_argument(
    ...
    puffer_config_dir = os.path.join(project_dir, "config/**/*.ini")
    puffer_default_config = os.path.join(project_dir, "config/default.ini")
    if env_name == "default":
